...
def HaarPSI(ref, deg, preprocess_with_subsampling=True, C=30.0, α=4.2):
    """
    Parameters:
        Mandatory:
            ref: torch.Tensor
    ...
    for orientation in [0, 1]:
        weights[orientation] = _get_weights_for_orientation(coeffs_deg_y, coeffs_ref_y, n_scales, orientation,
                                                            n_samples, height, width)
        local_similarities[orientation] = _get_local_similarity_for_orientation(C, coeffs_deg_y, coeffs_ref_y, n_scales,
                                                                                orientation)
